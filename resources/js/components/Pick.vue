<template>
	...
	<div v-if="editing">
		<div class="row update_grade_form no-gutters">
			<img class="cancel_grade_update" :src="'images/close-button.png'" alt="" @click="editing = false">
			<div class="col-12">
	...
	<div v-else>
		<div class="grade_info">
			<div class="row no-gutters">
				<p class="text-left col-6 text-capitalize mb-0" v-text="grade"></p>
				<button name="edit_grade" class="button black d-block edit_grade col-6" @click="editing = true">Edit Grade</button>
			</div>
		</div>
	</div>
